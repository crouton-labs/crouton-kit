...
- Save the high-level spec to `.claude/specs/{topic}.spec.md`
- Save pipeline state to `.claude/pipeline/{topic}.state.md`:
...
Investigate this feature and produce a high-level spec with open questions. The human will resume this session to iterate.
